...
/**
 * Troca caracteres que as fontes padrão do jsPDF (Helvetica/WinAnsi) não
 * conseguem representar. Elas os descartam SILENCIOSAMENTE: um travessão em
 * "CLÁUSULA 1ª — DO OBJETO" simplesmente sumia, deixando um buraco no PDF.
 * Acentos latinos (á, ç, ã, º, ª) passam sem problema e ficam como estão.
 */
